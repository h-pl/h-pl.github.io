...
**PS**： 别忘记在  Project Editor  执行File -> Compile 。
...
**首先，回到 Citect Explore。**
![](https://h-pl.github.io/post-images/1770866209508.png)
...
完成上述配置后，**必须先关机（shutdown）**，然后**完全重启 Runtime**（不仅是刷新，要关掉重开）。
